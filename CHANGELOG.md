...
## [2.0.0](https://github.com/muslewski/agentic-sage/compare/agentic-sage-v1.4.0...agentic-sage-v2.0.0) (2026-07-30)
...
* **about:** tmux session one-liners for ferry navigation ([5d91c6b](https://github.com/muslewski/agentic-sage/commit/5d91c6bb3d343d2dcbe6c34f3b2f9ecea6ac0c25))
...
* **board:** fold launcher-declared children into board and fleet ([2741aad](https://github.com/muslewski/agentic-sage/commit/2741aadfb5886536ce558c67b0e10a8e1df79985))
...
* **board:** roll up LIVE rows by lane past a viewport budget ([25bff96](https://github.com/muslewski/agentic-sage/commit/25bff96ebc222da11832caf0442bf93d88825545))
* **bridge:** read Agent Status Provider records as synthetic sessions ([7a68742](https://github.com/muslewski/agentic-sage/commit/7a68742062079217a0c75fbee5edd0a80096540d))
...
* **cli:** sage register — launcher-side session declaration (contract C4) ([de7bea4](https://github.com/muslewski/agentic-sage/commit/de7bea47d9b52d932c510bb25f4ff41830a522ee))
...
* **desk:** dual desk-gate with local bins + tests ([6c2f7d3](https://github.com/muslewski/agentic-sage/commit/6c2f7d33195041ef2162b956b9268ec96ce78312))
* **devlog:** emit fleet-devlog v1 alongside the existing local log ([abd5432](https://github.com/muslewski/agentic-sage/commit/abd54327fe3fd910f27fab6c2bacdc7b43afff04))
* **dist:** Codex plugin + Gemini install path + directory map ([16da2ae](https://github.com/muslewski/agentic-sage/commit/16da2aededfc9409cd8c009269f244bb1c816f4b))
* **dist:** Cursor plugin + multi-harness distribution docs ([7549989](https://github.com/muslewski/agentic-sage/commit/754998916ab644482374c70905ea0d702ca1daf7))
* **doctor:** detect fragile user-scope wiring ([3058d93](https://github.com/muslewski/agentic-sage/commit/3058d93469b1c8a55c001291c0f443651833d96f))
...
* fleet-follow preferred judge, sage gate, local telemetry ([975a0d8](https://github.com/muslewski/agentic-sage/commit/975a0d83b6ce5b6367c7c7b69c60c8d7260c4779))
* fleet-follow preferred judge, sage gate, local telemetry ([c92b48a](https://github.com/muslewski/agentic-sage/commit/c92b48a4bb1f146b87fc0e04430237031815612e))
...
* **grok:** ship agentic-sage as a Grok Build plugin ([bc43a77](https://github.com/muslewski/agentic-sage/commit/bc43a77c3de6e5c286f57b240c6a3d2f360ff54a))
...
* **prune:** fleet-wide prune with dry-run across every repo ([7015d5b](https://github.com/muslewski/agentic-sage/commit/7015d5b56f1bdee7e3d5bdc7cee5818a422885dc))
...
* v1.3.0 desk fleet OSS — gate, preferred, dual wire, past+present ([5cc8785](https://github.com/muslewski/agentic-sage/commit/5cc87859af6bf98d1fbe95a2e347396a513d58ac))
* v1.3.0 desk fleet OSS (past+present) ([5088749](https://github.com/muslewski/agentic-sage/commit/5088749cee2ecf2c2f688852beb53395acb8f545))
...
* **about:** drop stale judge lines when session topic pivots ([c605c8b](https://github.com/muslewski/agentic-sage/commit/c605c8b3a91ec179310c06eaf3903b6d221ec07c))
...
* **desk:** cold-review F1–F6 + critical containment/identity ([e783f64](https://github.com/muslewski/agentic-sage/commit/e783f6449a2aef281bc7211a6e22b7dd036e1031))
* **doctor:** ignore JSON hook bodies and nvm node interpreters ([f86ee5c](https://github.com/muslewski/agentic-sage/commit/f86ee5cf0cafd4230303498fd6fe9a38ef6df7ef))
* **emit:** SessionStart soft lines — preferred &gt; fleet &gt; wired lag, max 2 ([59fc047](https://github.com/muslewski/agentic-sage/commit/59fc04719815991648e3d19c8e0bae96d19e3675))
...
* **fleet-devlog:** re-vendor byte-identical work-kb reference ([93aa9a3](https://github.com/muslewski/agentic-sage/commit/93aa9a3f326164a224b97eb47b6023e1cc53c69d))
* **gate:** freshness probe must not mkdir missing sage home ([12fdbe7](https://github.com/muslewski/agentic-sage/commit/12fdbe7373962b34d25a588cfce173ae4a59560b))
* **gate:** preferred-offline probe skips agent-status synthetic merge ([a67083f](https://github.com/muslewski/agentic-sage/commit/a67083fee7dc48146bf014bab24ca2b2cf6e1d59))
...
* init --repair creates missing per-repo storage dir ([26767fd](https://github.com/muslewski/agentic-sage/commit/26767fd5e5178e6f636079155cb38bbf73196fdc))
* **judge:** pass interactive prompt argv to grok/claude harness ([ef0453e](https://github.com/muslewski/agentic-sage/commit/ef0453e1224925649318e7c53eca10d4b122bf2d))
...
* **territory:** path-boundary static prefix for both-glob overlaps ([52459ab](https://github.com/muslewski/agentic-sage/commit/52459abbbed91f109aec1bd32420f1f19239a552))
* **test:** spawn suite CLI via process.execPath under hermetic HOME ([5dc1470](https://github.com/muslewski/agentic-sage/commit/5dc1470036254f6ae731cbbaae746d08253d1599))
...
* **uninstall:** own stabilized package roots after worktree wire ([67220c3](https://github.com/muslewski/agentic-sage/commit/67220c3a402c2cac05ceffaae573b111235334a5))
...
* **Grok plugin:** `.grok-plugin/plugin.json` + `hooks/hooks.json` so Grok Build can install agentic-sage as a plugin (skills + emitter); PR to xAI Official marketplace
* **Cursor plugin:** `.cursor-plugin/plugin.json` (skills)
* **docs/distribution.md** — multi-harness install matrix (Grok, Claude, skills.sh, Cursor, Codex, Gemini)
