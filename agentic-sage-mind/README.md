# agentic-sage · Atlas mind

Code-verified knowledge vault for **agentic-sage** — architecture map (zones),
...
| Tech debt | `tech-debt/` |
| Public product docs | [`../docs/`](../docs/) (guides/reference — not this vault) |
