...
export const renderPanels = (totals = {}, heatValues = []) => {
  const t = { repos: 0, sessions: 0, live: 0, working: 0, contested: 0, compacting: 0, ...totals }
...
export const footer = (
  ...
  return ` ↵ enter · ↑↓ move · / filter · w ${wf} · c cd · m manage · a ${showAll ? 'dead✓' : 'all'} · q quit${fq}${pos}`
}
