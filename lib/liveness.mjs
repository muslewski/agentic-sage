...
// `phase` (e.g. 'compacting') is honored for hotness: compacting sessions are
// treated as 'working' (busy, collision-relevant) even without fresh last_tool.
export const deriveLiveness = ({
  ...
  if (phase === 'compacting') return 'working'
