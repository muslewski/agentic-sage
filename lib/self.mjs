// Resolve the CURRENT session's id — so a `sage claim` run from inside a session
// (Claude, Grok, etc) can write claimed_globs onto its OWN record without depending on an
