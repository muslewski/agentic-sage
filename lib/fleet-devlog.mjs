...
/**
 * Path to the canonical fleet-devlog reference module, if configured.
 * No desk/home absolute default — portable machines must set FLEET_DEVLOG_REF
 * (or tests discover a sibling checkout). Returns null when unset.
 * @param {NodeJS.ProcessEnv} [env]
 * @returns {string | null}
 */
export function referencePath(env = process.env) {
  const v = env.FLEET_DEVLOG_REF
